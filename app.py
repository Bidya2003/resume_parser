...
#     """
#     <style>
#     .title-centered {text-align: center; font-size:48px; font-weight:700; color:#fff;}
#     .subtle {color:#6b7280;}
#     .card {background: #8D8D8D; padding: 12px 18px; border-radius: 10px; box-shadow: 0 4px 14px rgba(2,22,89,0.06); }
#     .badge-green {background:#e6ffed; color:#05652a; padding:6px 10px; border-radius:6px; font-weight:600;}
#     .badge-red {background:#fff0f0; color:#b91c1c; padding:6px 10px; border-radius:6px; font-weight:600;}
#     .small-muted {font-size:13px; color:#6b7280;}
#     .course-button {margin:6px 0px;}
#     </style>
#     """,
...
#     rec_course = []
#     no_of_reco = st.slider('Choose Number of Course Recommendations:', 1, 10, 10)
...
# # Database Connection
# try:
#     connection = pymysql.connect(host='localhost', user='root', password='Bidya@2003', db='studentcourses')
...
#     with colC:
#         st.markdown('<div class="title-centered">AI Resume Analyser</div>', unsafe_allow_html=True)
#         st.markdown('<div class="small-muted" style="text-align:center">Upload your resume to get skills & course recommendations</div>', unsafe_allow_html=True)
#         st.write("")
...
#                 # Create a placeholder for storing summary
...
#                             st.session_state.resume_summary = summary  # ✅ store it persistently
...
#                     st.markdown(f"> {st.session_state.resume_summary}")
...
#                     st.write("")
#                     st.markdown('<div class="small-muted">Tip: Use the course check buttons below to see matched vs missing skills per course.</div>', unsafe_allow_html=True)
#                     st.markdown('</div>', unsafe_allow_html=True)
...
def run():
    ...
    with colC:
        st.markdown('<div class="title-centered">AI Resume Analyser</div>', unsafe_allow_html=True)
        st.markdown('<div class="small-muted">Upload your resume to get skills & course recommendations</div>', unsafe_allow_html=True)
        st.write("")
